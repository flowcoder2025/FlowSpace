...
**작업 시작 전 반드시 프로젝트의 `/CLAUDE.md`를 읽어야 합니다.**

이 파일은 프로젝트의 "헌법"으로서:
- 전역 원칙 (디자인 토큰, 버튼 규칙, 접근성)
- 개발 프로세스
- **작업 마무리 프로세스** (섹션 8)

를 정의합니다. 특히 **섹션 8 마무리 프로세스**는 모든 작업 완료 시 반드시 따라야 합니다.
