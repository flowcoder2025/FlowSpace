...
- [x] **공간 기반 커뮤니케이션** (2026-01-10)
  - [x] 근접 통신 시스템 (7×7 그리드 기반)
  - [x] 파티 존 시스템 (영역 기반 통신)
  - [x] 스포트라이트 시스템 (발표자 강조)
  - [x] @proximity / @근접 관리자 명령어
- [ ] PoC 데모 패키징 (대기)
...
- [x] **운영 도구** (2026-01-09)
  - [x] OCI 모니터링 대시보드 (메트릭/비용/트래픽)
  - [x] 사용량 측정 시스템 (리소스-사용량 상관관계)
  - [x] Discord Webhook 에러 알림
  - [x] Socket 서버 JSON 구조화 로깅 + ErrorCode 체계
  - [x] Cron Jobs (cleanup-sessions, cleanup-messages, collect-metrics, aggregate-usage)
