...
| AI_PROTOCOL | AI_PROTOCOL_FUNC_SESSION_START | - | O | X | BROKEN_EVIDENCE |
| AI_PROTOCOL | AI_PROTOCOL_FUNC_TASK_MANAGEMENT | - | O | O | SNAPSHOT_GAP |
| AI_PROTOCOL | AI_PROTOCOL_FUNC_CODE_DOC_SYNC | - | O | X | BROKEN_EVIDENCE |
...
| FOUNDATION | FOUNDATION_DESIGN_STATE_MACHINE | - | O | X | BROKEN_EVIDENCE |
