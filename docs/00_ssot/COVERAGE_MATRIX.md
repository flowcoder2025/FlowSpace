...
| AI_PROTOCOL | AI_PROTOCOL_FUNC_TASK_MANAGEMENT | - | O | - | PROCESS_BASED |
| AI_PROTOCOL | AI_PROTOCOL_FUNC_CODE_DOC_SYNC | - | O | O | PROCESS_BASED |
| AI_PROTOCOL | AI_PROTOCOL_FUNC_VERIFICATION | - | O | O | PROCESS_BASED |
| AI_PROTOCOL | AI_PROTOCOL_DESIGN_TASK_STRUCTURE | - | O | - | PROCESS_BASED |
| AI_PROTOCOL | AI_PROTOCOL_DESIGN_HANDOFF_STRUCTURE | - | O | - | PROCESS_BASED |
...
| INFRA | INFRA_FUNC_SOCKET_SERVER | - | O | O | INFRA_BASED |
...
|------|:----:|:---:|:-------:|:-----:|:------:|:-------:|:-----:|:--------:|
| 2026-01-24 | 116 | 0 | 11 | 8 | 0 | 0 | 0 | 100% |
