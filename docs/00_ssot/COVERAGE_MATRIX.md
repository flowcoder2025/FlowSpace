...
| INFRA | INFRA_FUNC_OCI_MONITORING | O | O | O | SYNC |
| INFRA | INFRA_FUNC_OCI_COST | - | O | O | SNAPSHOT_GAP |
| INFRA | INFRA_FUNC_METRICS_CRON | O | O | O | SYNC |
...
| SOCKET | SOCKET_FUNC_LOGGING | - | O | O | SNAPSHOT_GAP |
...
| UI_COMPONENT | UI_COMPONENT_FUNC_MEMBER_MGMT | - | O | O | SNAPSHOT_GAP |
| UI_COMPONENT | UI_COMPONENT_FUNC_ROLE_BADGE | - | O | O | SNAPSHOT_GAP |
| UI_COMPONENT | UI_COMPONENT_FUNC_MEMBER_SEARCH | - | O | O | SNAPSHOT_GAP |
...
|------|:----:|:-------:|:-----:|:------:|:---:|------|
| 2026-01-21 | 83 | 0 | 0 | 0 | 43 | specctl verify |
