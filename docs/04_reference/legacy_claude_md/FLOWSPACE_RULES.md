# FlowSpace 프로젝트 규칙 (레거시)

> **마이그레이션**: 2026-01-14
> **원본**: CLAUDE.md (v3.8.0)
> **정책**: Read-only, 업데이트 필요 시 DOC_DEBT에 기록
...
| 2025-12-07 | 3.0.0 | FlowSpace 프로젝트 반영 |
| 2026-01-09 | 3.8.0 | OCI 배포 완료 |
| 2026-01-14 | - | 레거시 마이그레이션 (FlowSubAgent 통합) |
